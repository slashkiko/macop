...
func run() throws {
    ...
    let expectedCompatibilityIDs: Set = [
        ...
        "ssh migration", "ssh migration status", "ssh migration orphans", "ssh migration prepare",
        "ssh migration public-key",
        "ssh migration confirm-registered", "ssh migration activate", "ssh migration retire",
        "ssh migration confirm-retired", "ssh migration rollback", "ssh migration delete-prepared",
        "ssh migration delete-orphan",
